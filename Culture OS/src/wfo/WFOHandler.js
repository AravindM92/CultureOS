...
Respond in JSON format:
{
  ...
  "clarity": "clear" | "unclear"
    ...
    async generateDailyMessage(userId) {
        ...
        Base message: "${baseTemplate}"
        User: ${userId}
        Context: Ask for their office plans for tomorrow (specifically the next calendar day).

        Requirements:
        - Be clear that you want to know if they plan to work from office or home tomorrow.
        - Mention the exact date for tomorrow (if available in context).
        - Keep it casual, friendly, and brief.
        - Make it sound like a quick check-in for coordination.
        - Add appropriate emoji.

        Example output:
        "Hi! 👋 Quick check-in: Will you be working from the office tomorrow (${this.getTomorrowDate()})? Just trying to coordinate! 😊"
