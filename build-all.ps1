...
Write-Host "  • .\start-all.bat - Start all services" -ForegroundColor Gray
Write-Host "  • .\test-all.bat - Test all services" -ForegroundColor Gray
Write-Host "  • .\stop-all.bat - Stop all services" -ForegroundColor Gray
Write-Host ""